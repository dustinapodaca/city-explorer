      ...
      <>
        ...
        <Container>
          <Card className="mb-4 bg-light mx-auto pb-1">
            <Card.Title id="weatherTitle" className="mb-3 rounded-top text-light p-3 mx-auto w-100">Daily Weather Forecast for {this.props.location.display_name}</Card.Title>
